...
\begin{figure}
	\includegraphics[width=11cm]{fig/lec01/Machine_Learning_Disciplines}
...
\frame{\frametitle{Typical supervised learning pipeline}
	\begin{figure}
		\includegraphics[width=8cm]{fig/lec08/ML_pipeline}
...
\frame{\frametitle{Supervised learning problem statement}
	...
	\begin{itemize}
		...
		\item The dimension $\xi$ of model parameters $\bm w \in \Re^\xi$ is adjustable in many model families, which trades off \hl{bias} with \hl{variance} (among other factors, leading to so-called under- and overfitting).\pause
...
\frame{\frametitle{Bias and variance}
	\begin{figure}
		\includegraphics[width=12cm]{fig/lec08/bias_variance}
...
\frame{\frametitle{$k$-fold cross-validation}
	...
	\begin{minipage}[c]{\linewidth}
		...
		\begin{figure}
			\includegraphics[width=\textwidth]{fig/lec08/kfold-cv}
...
\frame{\frametitle{Feature engineering example (classification)}
	...
	\begin{figure}
		\includegraphics[width=11cm]{fig/lec08/fe_example}
...
\frame{\frametitle{Feature engineering example (regression)}
	\begin{figure}
		\includegraphics[width=11cm]{fig/lec08/fe_example2}
...
\frame{\frametitle{Typical feature engineering schemes}
	...
	Given $K$ feature vectors $\bm x_k \in \Re^P$ with, e.g., $P=3$ (two real-valued regressors and a categorical independent variable $\bm x_k = (x_{k,r_1}, x_{k,r_2}, x_{k,c})$):\pause
	\begin{itemize}
...
\frame{\frametitle{Model choice}
	\begin{figure}
		\includegraphics[width=8.8cm]{fig/lec08/bigdrill}
...
\frame{\frametitle{Linear regression (2)}
	...
	\begin{block}{Multicollinearity}
		...
		\begin{align}
			\text{RSS}_\text{LASSO}(\bm w) &= (\bm y-\bm{\Xi w})\T(\bm y - \bm{\Xi w}) + \lambda\lVert\bm w\rVert_1, \\
			\text{RSS}_\text{Ridge}(\bm w) &= (\bm y-\bm{\Xi w})\T(\bm y - \bm{\Xi w}) + \lambda\lVert\bm w\rVert_2,
			\label{eq:ridge}
		\end{align}
...
\frame{\frametitle{Artificial neural networks}
	...
	\begin{minipage}[c]{\linewidth}
		...
		\begin{figure}
			\includegraphics[width=0.9\textwidth]{fig/lec08/neuron}
...
\frame{\frametitle{Multi-layer perceptron}
	...
	\begin{minipage}[c]{\linewidth}
		...
		\begin{figure}
			\includegraphics[width=0.8\textwidth]{fig/lec08/MLP}
...
\frame{\frametitle{Activation functions}
	...
	\begin{minipage}[r]{\linewidth}
		\begin{figure}
			\includegraphics[width=0.8\textwidth]{fig/lec08/act_funcs}
...
\begin{columns}[t,onlytextwidth]
	...
	\begin{minipage}[c]{\linewidth}
		\begin{figure}
		\includegraphics[width=0.8\textwidth]{fig/lec08/sgd}
		\caption{BGD vs. SGD}
		\label{fig:sgd}
	\end{figure}
	\end{minipage}
...
\frame{\frametitle{Advanced topologies}
    ...
    \begin{minipage}[t]{0.38\textwidth}
        \includegraphics[width=\textwidth]{fig/lec08/RNN_over_sequence}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.55\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig/lec08/CNN_over_sequence}
        \end{minipage}
...
\frame{\frametitle{Hyperparameter optimization (1)}
	\begin{figure}
		\includegraphics[width=9cm]{fig/lec08/levels_of_opt}
