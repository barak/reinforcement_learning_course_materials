...
\begin{frame}
	...
	\begin{minipage}[t]{0.27\linewidth}
		\centering
		\begin{figure}
			\includegraphics[height=2.75cm]{fig/lec01/Abdelwanis}
	...
	\begin{minipage}[t]{0.27\linewidth}
		\centering
		\begin{figure}
			\includegraphics[height=2.75cm]{fig/lec01/Wallscheid}
...
\begin{columns}[t]
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Hauke}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Jakobeit}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Kirchgaessner}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Meyer}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Schenke}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Vater}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Weber}
