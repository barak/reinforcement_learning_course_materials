...
\end{itemize}
\begin{figure}
\includegraphics[width=11cm]{fig/lec12/SLH_Benchmarks}
...
\begin{figure}
\includegraphics[height=5.75cm]{fig/lec12/DDPG}
...
\vspace{0.75cm}
\begin{figure}
\includegraphics[height=4cm]{fig/lec12/DDPG_Overestimation}
...
\vspace{0.775cm}
\begin{figure}
\includegraphics[height=4cm]{fig/lec12/Policy_Update_Frequency_TD3}
