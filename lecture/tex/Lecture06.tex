...
\begin{figure}		
	\includegraphics[height=0.65\textheight]{fig/lec06/Compare_RL_Methods_Update}
...
\begin{minipage}[c]{\linewidth}
	\begin{figure}		
	\includegraphics[height=0.65\textheight]{fig/lec06/Back_Up_n_Step_Methods}
...
\begin{figure}		
	\includegraphics[height=0.1\textheight]{fig/lec06/Random_Walk_19_States}
...
\begin{minipage}[c]{\linewidth}
	\begin{figure}		
	\includegraphics[height=0.45\textheight]{fig/lec06/n_Step_TD_Random_Walk}
...
As with the $n$-step TD, the state-action value target is rewritten:
		\begin{equation}
...
\begin{figure}		
	\includegraphics[height=0.75\textheight]{fig/lec06/Back_Up_n_Step_Sarsa}
...
\begin{figure}		
	\includegraphics[height=0.35\textheight]{fig/lec06/n_step_Sarsa_Grid_World_Example}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[height=0.65\textheight]{fig/lec06/Average_Bootstrap_Example}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[height=0.7\textheight]{fig/lec06/Lambda_Return_Backup}
...
\includegraphics[height=0.29\textheight]{fig/lec06/Lambda_Weighting_Series}
...
\end{itemize}
\onslide<1->{\begin{figure}
\includegraphics[height=0.25\textheight]{fig/lec06/Forward_View}
...
\end{itemize}
\onslide<1->{\begin{figure}
\includegraphics[height=0.4\textheight]{fig/lec06/Backward_View}
...
\end{equation}
\begin{figure}
\includegraphics[height=0.36\textheight]{fig/lec06/State_Visits_Eligibility_Trace}
...
\Init{$\pi$ to be $\varepsilon$-greedy with respect to $\hat{q}$ or to a given, fixed policy}
 \For{$j=1,\ldots,J$ episodes}{
		...
		\Repeat{$x_k$ is terminal}{
			...
			$z_k(x, u) \leftarrow \gamma\lambda z_{k-1}(x, u) +
                        \begin{cases}
                          0 & \text{if $x_k \neq x$ or $u_k \neq u$} \\
                          1 & \text{if $x_k = x$ and $u_k = u$.}
                        \end{cases}
                        $ 
...
\vspace{0.3cm}
\begin{figure}
\includegraphics[height=0.4\textheight]{fig/lec06/Traces_Sarsa_Gridworld}
