...
\begin{figure}
	\includegraphics[height=0.55\textheight]{fig/lec01/RL_Agent_Taxonomy}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.5\textheight]{fig/lec07/Markov_Decision_Process}
...
\onslide<1->{\begin{figure}
	\includegraphics[width=5.0cm]{fig/lec07/cards_dice}
...
\end{itemize}\pause
\begin{figure}
	\includegraphics[width=4.5cm]{fig/lec07/direct_indirect_RL}
...
\end{itemize}}
\onslide<1->{\begin{figure}
	\includegraphics[height=0.35\textheight]{fig/lec07/crossroads}
	\caption{Which way is better? (source: Mike Kononov on \href{https://unsplash.com/photos/FY0nQ-I3H_U}{Unsplash})}
\end{figure}}
}
...
\end{itemize}
\begin{figure}
	\includegraphics[width=7cm]{fig/lec07/Dyna}
...
\end{itemize}
\onslide<1->{\begin{figure}
	\includegraphics[width=5cm]{fig/lec07/Dyna}
\end{figure}}
}
...
\begin{figure}
	\includegraphics[width=7cm]{fig/lec07/Dyna_Simple_Maze}
...
\end{itemize}
\begin{figure}
	\includegraphics[width=7.5cm]{fig/lec07/Dyna_Simple_Maze_Updates}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=6.75cm]{fig/lec07/Dyna_Q_Shortcut}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item $\kappa$: is a small positive scaling factor, $\kappa>0$.
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=6.75cm]{fig/lec07/Prior_Sweeping_Dyna}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.4\textheight]{fig/lec07/Heuristic_search_tree}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.4\textheight]{fig/lec07/Rollout}
...
\end{itemize}
\begin{figure}
	\includegraphics[height=0.55\textheight]{fig/lec07/MCTS}
