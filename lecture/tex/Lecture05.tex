...
\begin{minipage}[c]{\linewidth}
	\begin{figure}
		\includegraphics[width=0.5cm]{fig/lec05/Back_Up_TD}
...
\begin{figure}		
	\includegraphics[height=0.65\textheight]{fig/lec05/Compare_RL_Methods_Update}
...
\begin{figure}		
	\includegraphics[width=9cm]{fig/lec05/Driving_home_example}
...
\begin{figure}		
	%\hspace*{-1.5cm}
	\includegraphics[height=0.55\textheight]{fig/lec04/Forest_Markov_Decision_Process_State_Value}
...
\begin{figure}		
	\includegraphics[height=0.7\textheight]{fig/lec05/Forest_Tree_TD0_Prediction}
...
\begin{figure}		
	\includegraphics[height=0.7\textheight]{fig/lec05/Forest_Tree_TD0_MC_RMS_Prediction_Zero_Init_500_eps}
...
\begin{figure}		
	\includegraphics[height=0.7\textheight]{fig/lec05/Forest_Tree_TD0_MC_RMS_Prediction_Good_Init_200_eps}
...
\begin{minipage}[c]{\linewidth}
	\begin{figure}
		\includegraphics[width=4.0cm]{fig/lec05/Batch_AB_Example}
...
\begin{itemize}
	...
	\begin{equation}
		\pi_i(u|x)\leftarrow
                \begin{cases}
                  1-\varepsilon+\varepsilon/\lvert\mathcal{U}\rvert & (u=\tilde{u})\\
                  \varepsilon/\lvert\mathcal{U}\rvert & (u\neq\tilde{u})\text{.}
                \end{cases}
	\end{equation}
\end{itemize}
}
...
\begin{figure}		
	\includegraphics[height=0.65\textheight]{fig/lec05/Forest_Tree_Sarsa_alpha_0.2}
...
\begin{figure}		
	\includegraphics[height=0.65\textheight]{fig/lec05/Forest_Tree_Sarsa_alpha_0.1}
...
\begin{figure}		
	...
	\caption{SARSA-based control with \hl{adaptive $\alpha_{\mathrm{SARSA}}=\frac{1}{\sqrt{j}}$} ($j=\text{episode}$) and $\varepsilon$-greedy policy with $\varepsilon=0.2$ of forest tree MDP over the number of episodes being evaluated \\ (mean and standard deviation are calculated based on 2000 independent runs)}
...
\begin{minipage}[t]{\linewidth}
	\begin{figure}
		\includegraphics[width=5.0cm]{fig/lec05/Cliff_Walking}
...
\begin{figure}		
	\hspace*{-1.0cm}
	\includegraphics[width=9cm]{fig/lec05/Double_Learning_Example}
