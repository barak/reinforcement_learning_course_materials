...
\onslide<1->
\begin{figure}
	\includegraphics[height=0.5\textheight]{fig/lec01/Rock_paper_scissors_lizard_spock}
...
\end{itemize}
\begin{figure}
\includegraphics[width=5.5cm]{fig/lec11/Gaussian_Distri}
...
\end{equation*}
\begin{figure}
\includegraphics[width=6.5cm]{fig/lec11/Gaussian_Policy_Multivariate}
...
\begin{itemize}
	...
	\end{itemize}}
	\onslide<3->{\item Hence, we might consider global optimization techniques\footnote[1]{\onslide<3->{Recommended reading: J. Stork et al., \textit{A new Taxonomy of Continuous Global Optimization Algorithms}, Natural Computing \textbf{21}:219--242, \href{https://doi.org/10.1007/s11047-020-09820-4}{doi:10.1007/s11047-020-09820-4}, 2022}} like
		\begin{itemize}
...
\begin{figure}
	\includegraphics[width=4.5cm]{fig/lec11/Gradient_ascent}
...
\begin{itemize}
	...
	\begin{equation*}
	\nabla_{\bm{\theta}} J(\bm{\theta}) = \El{q_{\pi}(\bm{x},\bm{u})\nabla_{\bm{\theta}}\ln \pi(\bm{u}|\bm{x},\bm{\theta})}{\pi} \,\,\text{?}
\end{equation*}
\end{itemize}
\vspace{0.5cm}\pause
...
\includegraphics[height=0.5\textheight]{fig/lec11/Short_Corridor_Problem}
...
\begin{figure}
\includegraphics[height=0.65\textheight]{fig/lec11/REINFORCE_short_corridor}
...
\begin{figure}
\includegraphics[height=0.65\textheight]{fig/lec11/REINFORCE_short_corridor_baseline}
...
\end{itemize}
\begin{figure}
\includegraphics[height=0.5\textheight]{fig/lec11/Actor-Critic}
...
\begin{itemize}
	\item As with MC-based policy gradient methods, optional discounting on the gradient updates is introduced.
\end{itemize}
\setlength{\algomargin}{0.5em}
\begin{algorithm}[H]
\SetKwInput{Input}{input} 
