...
\frame{\frametitle{Task-dependent return definitions}
  ...
  \item The return should be \hl{discounted} to prevent infinite numbers:
    ...
    \item Equation for $g_k$ chosen for mathematical convenience.
  \end{itemize}
}
...
\frame{
  ...
  \begin{block}{WARNING}
    \begin{Large}
      When building systems, think really hard about what to use for the state. Does it have all the necessary information? Are you leaving out something important? Are you making it too big, so hard to learn?
    \end{Large}
  \end{block}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
