...
\frame{
  ...
  \begin{block}{\centerline{\LARGE WARNING}}
    \begin{Large}
      ...
      \begin{itemize}
      \item Does it have all the necessary information?
      \item Are you leaving out something important?
      \item The state is \emph{now} but might need to include past information.
      \item If you leave out something critical the task can become impossible!
