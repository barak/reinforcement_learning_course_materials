...
\begin{table}
	\centering
		\begin{tabular}{lll}
			...
			\bottomrule
		\end{tabular}
	\onslide<1->\caption{Key differences on MPC vs. RL\\(inspired from D. G̦rges, \textit{Relations between Model Predictive Control and Reinforcement Learning}, IFAC PapersOnine 50-1, pp. 4920-4928, 2017)}
