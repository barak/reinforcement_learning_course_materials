\section{Introduction to Reinforcement Learning: Course Framework}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Course-specific introductory material
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Select one of the following two files to input:
% - Lecture01_intro_master.tex (Maynooth University CS637 version)
% - Lecture01_intro_upmaster.tex (Paderborn/Siegen version)
%\input{tex/Lecture01_intro_Paderborn}
\input{tex/Lecture01_intro_MU_CS637}
...
\begin{frame}
  ...
  \item Reinforcement Learning: The Silver Lectures
    \begin{itemize}
    \item David Silver
    \item Slides available at \url{https://www.davidsilver.uk/teaching/}
...
\frame{\frametitle{The basic reinforcement learning structure}
  \begin{columns}[t,onlytextwidth]
	...
	\begin{figure}
	  \includegraphics[height=0.6\textheight]{fig/lec01/RL_Wiki}
...
\frame{\frametitle{Agent and environment}
  \begin{minipage}[t]{0.5\linewidth}
    \begin{figure}
      \includegraphics[height=0.55\textheight]{fig/lec01/RL_Wiki}
    \end{figure}
  \end{minipage}
  \hfill
...
\frame{\frametitle{RL: Some basic definitions from the literature}
  ...
  \begin{block}{What is \hl{Learning}?}
    \begin{itemize}
    \item ``\textit{Acquiring knowledge and skills and having them readily available from memory so you can make sense of future problems and opportunities.}'' (Brown et al., \emph{Make It Stick: The Science of Successful Learning}, Harvard Press, 2014)
    \end{itemize}
  \end{block}
}
...
\frame{\frametitle{Context around reinforcement learning}
  \begin{figure}
    \includegraphics[height=0.8\textheight]{fig/lec01/Machine_Learning_Disciplines}
...
\frame{\frametitle{Context around machine learning}
  \begin{figure}
    \centering
    \includegraphics[height=0.8\textheight]{fig/lec01/ML_AI}
...
\frame{\frametitle{Many faces of reinforcement learning}
  \hfill
  \includegraphics[height=0.85\textheight]{fig/lec01/Faces_RL}
  \hfill
...
\begin{minipage}[t]{0.27\linewidth}
	\begin{figure}
		\includegraphics[width=3.0cm]{fig/lec01/Pavlov}
...
\begin{minipage}[t]{0.27\linewidth}
	\begin{figure}
		\includegraphics[width=3.0cm]{fig/lec01/Markov}
...
\begin{minipage}[t]{0.27\linewidth}
	\begin{figure}
		\includegraphics[width=3.0cm]{fig/lec01/Bell_man}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Kaelbling et al., \textit{Reinforcement learning: A survey}, Journal of Artificial Intelligence Research \textbf{4}:237--285, 1996
		\item Arulkumaran et al., \textit{Deep reinforcement learning: a brief survey}, IEEE Signal Processing Magazine \textbf{34}\textit{(6)}:26--38, 2017
		\item Botvinick et al., \textit{Reinforcement learning, fast and slow}, Trends in Cognitive Sciences \textbf{23}\textit{(5)}:408--422, 2019
	\end{itemize} 
\end{itemize}
}
...
Rewards can have many different flavors and are highly dependant on the given problem:
\begin{itemize}
...
\end{itemize}
\begin{figure}
		\includegraphics[width=6cm]{fig/lec01/Midas}
...
\begin{itemize}
	...
	\item Here, $\gamma\in\left\{\Re|0 \leq \gamma \leq 1\right\}$ is the \hl{discount rate}.
        \item Why this form? Mathematical convenience!
\end{itemize}
}
...
\frame{
  \frametitle{State (3)}
  \begin{block}{\centerline{\LARGE WARNING}}
    \begin{Large}
      When building systems, think really hard about what to use for the ``state''.
      \begin{itemize}
      \item State is \emph{now}, may need to include past observations.
      \item Does it have \hl{all} necessary information?

        It is easy to leave out something important.

        If you leave out something critical the task can become impossible!
      \item \hl{This was the root cause of many (most) class projects that didn't work.}
      \item Are you making it too big, so hard to learn?
      \end{itemize}
    \end{Large}
  \end{block}
}
...
\begin{equation}
	\mathbb{H}_k = (\bm{y}_0, r_0, \bm{u}_0, \ldots, \bm{u}_{k-1}, \bm{y}_k, r_k)
\end{equation}
...
\hlh{POMDP examples}
	...
	\item Poker game (opponents' cards are unknown)
	\item Human health status (system is too complex)
\end{itemize}
}
...
\onslide<1->\begin{figure}
	\includegraphics[width=10cm]{fig/lec01/Control_Loop}
...
\onslide<1->
\begin{figure}
	\includegraphics[height=0.45\textheight]{fig/lec01/Rock_paper_scissors_lizard_spock}
...
\end{itemize}	
\begin{figure}
	\includegraphics[width=7cm]{fig/lec01/Exploration_Exploitation}
...
\begin{minipage}[c]{0.5\linewidth}
	\begin{figure}
		\includegraphics[width=6cm]{fig/lec01/Maze_Basic}
...
\begin{minipage}[c]{0.55\linewidth}
	\begin{figure}
		\includegraphics[width=6cm]{fig/lec01/Maze_Policy}
...
\begin{minipage}[c]{0.55\linewidth}
	\begin{figure}
		\includegraphics[width=6cm]{fig/lec01/Maze_Value}
...
\begin{minipage}[c]{0.55\linewidth}
	\begin{figure}
		\includegraphics[width=6cm]{fig/lec01/Maze_Model}
...
\begin{figure}
	\includegraphics[height=0.7\textheight]{fig/lec01/RL_Agent_Taxonomy}
...
The reward hypothesis in \theoref{theo:reward_hypo} is basically a (discounted) \hl{infinite-horizon optimal control} problem (with $r_k$ interpreted as costs):
\begin{equation}
...
\begin{table}
	\centering
		\begin{tabular}{lll}
			...
			\bottomrule
		\end{tabular}
	\onslide<1->\caption{Key differences on MPC vs.\ RL\\(inspiration from D. Görges, \textit{Relations between Model Predictive Control and Reinforcement Learning}, IFAC PapersOnine 50-1:4920--4928, 2017)}
