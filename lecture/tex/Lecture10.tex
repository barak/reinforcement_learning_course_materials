...
\Param{step size $\alpha\in\left\{\Re \vert 0<\alpha<1\right\}$, $\varepsilon\in\left\{\Re \vert 0<\varepsilon\ll 1\right\}$}
...
\Input{a differentiable function $\hat{q}:\Re^\kappa\times\Re^\zeta\rightarrow\Re$}
\Input{a policy $\pi$ (only if estimating $q_\pi$)}
\Param{$\alpha\in\left\{\Re \vert 0<\alpha<1\right\}$, $\varepsilon\in\left\{\Re \vert 0<\varepsilon\ll 1\right\}$, $n\in\mathbb{Z}^+$}
\Init{parameter vector $\bm{w}\in\Re^\zeta$ arbitrarily}
 \For{$j=1,2\ldots$ episodes}{
...
\Param{an accuracy threshold $\Delta\in\left\{\Re \vert 0<\Delta\right\}$}
...
\Param{forgetting factor $\lambda\in\left\{\Re \vert 0 < \lambda \leq 1\right\}$, $\varepsilon\in\left\{\Re \vert 0<\varepsilon\ll 1\right\}$, update factor $k_w\in\left\{\mathbb{N}|1\leq k_w\right\}$}
...
\Param{$\varepsilon\in\left\{\Re \vert 0<\varepsilon\ll 1\right\}$, update factor $k_w\in\left\{\mathbb{N}|1\leq k_w\right\}$}
