...
\begin{figure}
\includegraphics[height=0.45\textheight]{fig/lec10/Model_types_action_value}
...
\begin{figure}
\includegraphics[height=2.5cm]{fig/lec03/GPI_02}
\caption{GPI}
\end{figure}
\end{minipage}
\end{column}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=4.8cm]{fig/lec10/mountain_car}
...
\begin{itemize}
	...
	\item<2-> One discrete action: acceleration given by $\left\{\text{left},\text{none},\text{right}\right\}$ 
...
\begin{figure}
\includegraphics[height=0.65\textheight]{fig/lec10/Mountain_Car_BS}
...
\end{itemize}
\begin{figure}
\includegraphics[width=10cm]{fig/lec10/Tile_Coding}
...
\end{itemize}
\begin{figure}
\includegraphics[height=0.3\textheight]{fig/lec03/GPI_02}
\end{figure}\pause
Some remarks:
\begin{itemize}
...
\Repeat{$\lVert\bm{w}'-\bm{w}\rVert<\Delta$}{
		$\bm{w}' \leftarrow \bm{w}$\;
		$\bm{w}\leftarrow\text{LS-SARSA}(\bm{\mathcal{D}}, u_{i+1}\sim\pi)$\;
...
\begin{itemize}
	...
	\item Source: M. Lagoudakis and R. Parr, \textit{Least-Squares Policy Iteration}, Journal of Machine Learning Research \textbf{4}:1107--1149, 2003
\end{itemize}
}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=4.8cm]{fig/lec10/Inv_pendulum}
...
\end{itemize}
\begin{figure}
\includegraphics[height=4.2cm]{fig/lec10/LSPI_Inv_Pendulum}
\caption{Balancing steps before episode termination with a clipping of maximum 3000 steps (source: M. Lagoudakis and R. Parr, \textit{Least-Squares Policy Iteration}, Journal of Machine Learning Research \textbf{4}:1107--1149, 2003)}
\end{figure}
}
...
\begin{figure}
\includegraphics[height=5.5cm]{fig/lec10/DQN}
...
\begin{itemize}
	\item General framework is based on V. Mnih et al., \textit{Human-level control through deep reinforcement learning}, Nature \textbf{518}:529--533, 2015, doi:10.1038/nature14236.\pause
...
\end{itemize}
\begin{figure}
\includegraphics[height=0.4\textheight]{fig/lec10/DQN_Network_Silver}
...
\begin{figure}
\includegraphics[height=0.7\textheight]{fig/lec10/DQN_Atari_Results}
