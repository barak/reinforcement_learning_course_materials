...
\begin{figure}
	\includegraphics[width=11cm]{fig/lec12/RL_Categories}
...
\begin{itemize}
	...
	\item \hl{Imitation learning}: how can we mimic the behavior of a certain baseline agent / controller / human expert? 
		\begin{itemize}
		\item \href{https://dl.acm.org/doi/pdf/10.1145/3054912}{A. Hussein et al., \emph{Imitation learning: A survey of learning methods}, ACM Computing Surveys (CSUR) \textbf{50}\textit{(2)}:1--35, 2017}
		\item \href{https://arxiv.org/pdf/1705.10528}{A. Attia and S. Dayan, \emph{Global overview of imitation learning}, arXiv:1801.06503, 2018}
	\end{itemize}
\end{itemize}
}
...
\begin{itemize}
	...
	\item \hl{Federated learning}: finding solutions to distributed problems via multiple independent sessions, each using its own local information (addressing critical issues such as data privacy, data security, data access rights).
			\begin{itemize}
		\item \href{https://arxiv.org/abs/1901.08277}{H. Zhuo et al. \emph{Federated Deep Reinforcement Learning}, arXiv:1901.08277, 2019}
		\item \href{https://arxiv.org/abs/2108.11887}{J. Qi et al. \emph{Federated Reinforcement Learning: Techniques, Applications, and Open Challenges}, arXiv:2108.11887, 2021}
	\end{itemize}
\end{itemize}
}
