...
\begin{figure}
\centering
\includegraphics[height=0.4\textheight]{fig/lec01/MPC}
...
\begin{figure}
 ...
 \begin{columns}
        ...
        \column{.3\linewidth}
        \includegraphics[width=\textwidth]{fig/lec14/Human-Robot-Collaboration}
				\column{.3\linewidth}
        \includegraphics[width=\textwidth]{fig/lec14/Waymo}
				\column{.2\linewidth}
      ...
      \end{columns}
        ...
        \column{.3\linewidth}
        \includegraphics[width=\textwidth]{fig/lec14/microgrid}
				\column{.3\linewidth}
        \includegraphics[width=\textwidth]{fig/lec14/Insulin_pump}
				\column{.2\linewidth}
...
\begin{figure}
\centering
\includegraphics[height=0.68\textheight]{fig/lec14/Safety_Levels}
...
\begin{figure}%
\centering
\subfloat[][Safety critic: add a critic which indicates to which extent the current data sample fits to a safe situation]{\includegraphics[width=0.375\textwidth]{fig/lec14/RL_Safety_Critic}}%
\qquad
\subfloat[][Safety shield: use a priori or learned model knowledge of the environment to make predictions identifying actions leading to unsafe situations]{\includegraphics[width=0.375\textwidth]{fig/lec14/Safe_RL_Shield}}%
...
\begin{figure}
\centering
\includegraphics[height=0.68\textheight]{fig/lec14/Safeguard_Classes}
...
\begin{figure}%
\centering
\subfloat[][Example microgrid that can be emulated in the \href{https://ei.uni-paderborn.de/lea/research/forschungsprojekte/intelligent-energy-systems/microgrid-laboratory}{LEA Microgrid Laboratory}.]{\includegraphics[width=0.45\textwidth]{fig/lec14/MG_vogt}}%
\qquad
\subfloat[][Application under investigation: Three-phase grid-forming inverter disturbed by stochastic load]{\includegraphics[width=0.45\textwidth]{fig/lec14/UPS_LC_Structure}}%
...
\begin{figure}
	\includegraphics[width=0.8\textwidth, height=0.65\textheight]{fig/lec14/RL_Safety_Critic_OMG}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	%\includegraphics[width=1.11\textwidth, height=0.8\textheight]{fig/lec14/Reward_v_mre}
	\includegraphics[trim=50 40 10 60, clip, width=1.1\linewidth]{fig/lec14/Reward_v_mre}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=0.9\textwidth, height=0.65\textheight]{fig/lec14/Safe_RL_Shield_OMG}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=0.85\textwidth, height=0.55\textheight]{fig/lec14/OMG_all_aborts_log}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[width=0.75\textwidth, height=0.55\textheight]{fig/lec14/370_vDC_SL_RLS_varLoadtimeseries_testcase}
...
\begin{figure}
\centering
\includegraphics[height=0.68\textheight]{fig/lec14/DDPG_Real_Time}
...
\begin{figure}%
\centering
\subfloat[][Real-time control requirement vs. learning time]{\includegraphics[width=0.45\textwidth]{fig/lec14/Timing}}%
\qquad
\subfloat[][Typical evolution of RL parameter weights during learning]{\includegraphics[width=0.45\textwidth]{fig/lec14/NN-Weights}}%
\label{fig:timing}%
\end{figure}
}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[scale=0.35]{fig/lec14/Safeguarded_DQDTC_Scheme}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[scale=0.4]{fig/lec14/CPU_vs_FPGA}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[scale=0.5]{fig/lec14/Edge_RL_Pipeline}
...
\begin{tikzpicture}[overlay, remember picture]
	\node[anchor = center, inner sep=0pt, xshift=0.5cm] at (current page.center) {
		\href{https://www.youtube.com/watch?v=hQ49Mc6LV78&t=13}{\includegraphics[width=0.7\paperwidth]{fig/lec14/Youtube_preview}}
	};
	\node[anchor = center, inner sep=0pt, xshift=0.5cm] at (current page.center) {
...
\begin{figure}%
\centering
\subfloat[][General problem class is similar, environments only differ in some characteristics, the agent could transfer learned behavior]{\includegraphics[scale=0.6]{fig/lec14/Meta_RL_Set_MDPS}}%
\qquad
\subfloat[][Solution approach: treat the environment as partially observable, distinguishing details are not directly available]{\includegraphics[scale=0.6]{fig/lec14/Meta_RL_POMDP}}%
\end{figure}
}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[scale=1.0]{fig/lec14/MetaLearningConcepts}
...
\begin{figure}
	\includegraphics{fig/lec14/MetaProblemMotoren}
...
\begin{figure}
	\includegraphics[scale=1.2]{fig/lec14/MetaLoesungMotoren}
...
\begin{minipage}[c]{\linewidth}
\begin{figure}
	\includegraphics[scale=0.375]{fig/lec14/Meta_Scheme}
...
\begin{figure}%
\centering
\subfloat[][Current control on a PMSM with low rated power]{\includegraphics[scale=0.37]{fig/lec14/MetaLowPowerExample}}%
\qquad
\subfloat[][Current control on a PMSM with high rated power]{\includegraphics[scale=0.37]{fig/lec14/MetaHighPowerExample}}%
\end{figure}
}
