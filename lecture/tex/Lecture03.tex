...
\begin{itemize}
	...
	\item A proof of the policy improvement theorem for deterministic policies was presented, but transfer to stochastic policies $\pi(u_k|x_k)$ is possible.\pause
