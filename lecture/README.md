...
- `tex/` — individual `.tex` files for each chapter/section of the course.
  - `tex/Lecture01_intro_master.tex` — Maynooth University version of course intro (Lecture 01)
  - `tex/Lecture01_intro_upmaster.tex` — Paderborn/Siegen version of course intro (Lecture 01)
