...
\frame{\frametitle{$\varepsilon$-greedy as an on-policy alternative}
  \begin{itemize}
  \item Exploration requirement:\\[1ex]
    ...
    \item<4-> The level of exploration can be tuned during learning.
    \end{itemize}
    \end{minipage}
    \hfill
    \onslide<2->{\includegraphics[width=0.24\textwidth]{fig/lec04/never-say-never-again-poster.jpg}}
    \onslide<5->
    \vfill
  \item \hl{$\varepsilon$-greedy on-policy learning}
    ...
    \item Probability of the greedy action:
      ...
      \end{equation}
      where $\lvert\mathcal{U}\rvert$ is the cardinality of the action space.
    \end{itemize}
  \end{itemize}
}
