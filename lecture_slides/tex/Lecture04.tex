...
\frame{\frametitle{$\varepsilon$-greedy as an on-policy alternative}
  ...
  \item Exploration requirement:\\[1ex]
    ...
    \item The level of exploration can be tuned during learning.
    \end{itemize}
    \end{minipage}
    \hfill
    \pause
    \includegraphics[width=0.24\textwidth]{fig/lec04/never-say-never-again-poster.jpg}
    \pause
    \vfill
...
\frame{\frametitle{Algorithmic implementation $\varepsilon$-greedy MC-control}
  ...
  \begin{algorithm}[H]
	...
	\If{$\left\{x_{k}, u_{k}\right\}\notin \left\langle \left\{x_{0}, u_{0}\right\}, \ldots, \left\{x_{k-1}, u_{k-1}\right\}\right\rangle$}{
	  ...
	  $\pi_i(u\vert x_k)\leftarrow\begin{cases}1-\varepsilon+\varepsilon/\lvert\mathcal{U}\rvert , \quad u=\tilde{u}\\ \varepsilon/\lvert\mathcal{U}\rvert , \quad u\neq\tilde{u}\end{cases}$\;
	}
      }
    }
