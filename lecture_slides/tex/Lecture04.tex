...
\frame{\frametitle{$\varepsilon$-greedy as an on-policy alternative}
  ...
  \item Exploration requirement:
    ...
    \item Visit all state-action pairs with probability:
      \begin{equation}
	\pi(u\vert x) > 0 \quad \forall\, \left\{x\in\mathcal{X}, u\in\mathcal{U}\right\}\, .
      \end{equation}
  ...
  \item \hl{$\varepsilon$-greedy on-policy learning}
    ...
    \item Probability of the greedy action: \begin{equation}1-\varepsilon+\varepsilon/\lvert\mathcal{U}\rvert\,.\end{equation}
    \item Above, $\lvert\mathcal{U}\rvert$ is the cardinality of the action space.
    \end{itemize}
  \end{itemize}
}
