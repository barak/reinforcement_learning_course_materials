...
\begin{columns}[t]
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/BHK.png}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Jakobeit.png}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Meyer.png}
	...
	\begin{figure}
		\centering
			\includegraphics[height=2.75cm]{fig/lec01/Weber.png}
...
\begin{block}{Contact}
	\begin{itemize}
		\item Email: see \href{https://ei.uni-paderborn.de/en/lea/team/arbeitsgruppe/team}{departments homepage}
...
\begin{itemize}
	\item Will be made available via Panda at end of the lecture series.
